/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 684993fd459cfb21876512333cc5b13a)
// Runtime types generated with workerd@1.20260708.1 2026-07-11 
interface __BaseEnv_Env {
	EDGE_ENVIRONMENT: "staging" | "production" | "development";
	FLOOR_SOCKET_CAP: "100";
	FLOOR_MESSAGES_PER_MINUTE: "120";
	FLOOR_MESSAGE_BURST: "24";
	FLOOR_EVENTS_PER_SECOND: "250";
	FLOOR_EVENT_BURST: "400";
	FLOOR_SESSION_TOMBSTONE_CAP: "10000";
	FLOOR_REPLAY_GRACE_SECONDS: "600";
	REALM_DIRECTORY_BUCKETS: "64";
	REALM_DIRECTORY_SUPPORTED_BUCKET_COUNTS: "64";
	REALM_DIRECTORY_FLOOR_LIMIT: "256";
	REALM_DIRECTORY_RESERVATION_SECONDS: "65";
	REALM_DIRECTORY_RECEIPT_LIMIT: "32768";
	ROUTE_TICKET_TTL_SECONDS: "60";
	ROUTE_TICKET_AUDIENCE: "grokhack-edge-game";
	ROUTE_TICKET_ISSUER: "grokhack-session-control";
	ROUTE_TICKET_KEY_ID: "staging-v1" | "production-v1" | "development-v1";
	ROUTE_TICKET_PREVIOUS_KEY_ID: "staging-v0" | "production-v0" | "development-v0";
	ALLOWED_BROWSER_ORIGINS: "https://staging.grokhack.mondello.dev" | "https://grokhack.mondello.dev" | "http://localhost:5173,http://127.0.0.1:5173";
	ROUTE_TICKET_SECRET: string;
	ROUTE_TICKET_PREVIOUS_SECRET: string;
	SHADOW_INGEST_SECRET: string;
	FLOOR_INSTANCES: DurableObjectNamespace<import("./index").FloorInstance>;
	PLAYER_SESSIONS: DurableObjectNamespace<import("./index").PlayerSession>;
	REALM_DIRECTORIES: DurableObjectNamespace<import("./index").RealmDirectory>;
	SHADOW_REPLAYS: DurableObjectNamespace<import("./index").ShadowReplay>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "FloorInstance" | "PlayerSession" | "ShadowReplay" | "RealmDirectory";
	}
	interface StagingEnv {
		EDGE_ENVIRONMENT: "staging";
		FLOOR_SOCKET_CAP: "100";
		FLOOR_MESSAGES_PER_MINUTE: "120";
		FLOOR_MESSAGE_BURST: "24";
		FLOOR_EVENTS_PER_SECOND: "250";
		...
		ROUTE_TICKET_AUDIENCE: "grokhack-edge-game";
		ROUTE_TICKET_ISSUER: "grokhack-session-control";
		ROUTE_TICKET_KEY_ID: "staging-v1";
		ROUTE_TICKET_PREVIOUS_KEY_ID: "staging-v0";
		ALLOWED_BROWSER_ORIGINS: "https://staging.grokhack.mondello.dev";
		ROUTE_TICKET_SECRET: string;
		ROUTE_TICKET_PREVIOUS_SECRET: string;
		SHADOW_INGEST_SECRET: string;
		FLOOR_INSTANCES: DurableObjectNamespace<import("./index").FloorInstance>;
	...
	interface ProductionEnv {
		...
		ROUTE_TICKET_AUDIENCE: "grokhack-edge-game";
		ROUTE_TICKET_ISSUER: "grokhack-session-control";
		ROUTE_TICKET_KEY_ID: "production-v1";
		ROUTE_TICKET_PREVIOUS_KEY_ID: "production-v0";
		ALLOWED_BROWSER_ORIGINS: "https://grokhack.mondello.dev";
		ROUTE_TICKET_SECRET: string;
		ROUTE_TICKET_PREVIOUS_SECRET: string;
		SHADOW_INGEST_SECRET: string;
		FLOOR_INSTANCES: DurableObjectNamespace<import("./index").FloorInstance>;
